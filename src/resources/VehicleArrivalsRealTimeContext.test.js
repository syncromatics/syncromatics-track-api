...
describe('When creating a subscription for vehicle arrivals', () => {
  const entity = 'VEHICLE_ARRIVALS';
  ...
  beforeEach(() => {
    ...
    subject = new VehicleArrivalsRealTimeContext(realTimeClient, customerCode);
  });
