...
describe('When instantiating trip cancelations based on customer', () => {
    ...
    it('should set the href', () => batch.href.should.equal('/2/SYNC/serviceadjustments/tripcancelations'));
...
describe('When fetching trip cancelations based on customer', () => {
    ...
    it('should set the href', () => promise.then(x => x.href).should.eventually.equal('/2/SYNC/serviceadjustments/tripcancelations'));
...
describe('When creating trip cancelations for a customer', () => {
    ...
    let promise;
    beforeEach(() => {
        promise = new TripCancelationBatch(client, {
            code: 'SYNC',
            ...{
                cancelations:
                    [{
