...
describe('When getting resources related to a customer', () => {
  ...
  it('should allow roles to be searched', () => customer.roles().should.be.instanceOf(RolesContext));
  it('should allow a role to be retrieved', () => customer.role().should.be.instanceOf(Role));
  ...
  it('should allow a user to be retrieved', () => customer.user().should.be.instanceOf(User));
  it('should allow users to be searched', () => customer.users().should.be.instanceOf(UsersContext));
