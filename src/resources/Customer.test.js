...
describe('When getting resources related to a customer', () => {
  ...
  it('should allow an assignable route to be retrieved', () => customer.assignableRoute().should.be.instanceOf(AssignableRoute));
  it('should allow a list of assignable routes to be retrieved', () => customer.assignableRoutes().should.be.instanceOf(AssignableRoutesContext));
  it('should allow an assignable stop to be retrieved', () => customer.assignableStop().should.be.instanceOf(AssignableStop));
  it('should allow a list of assignable stops to be retrieved', () => customer.assignableStops().should.be.instanceOf(AssignableStopsContext));
